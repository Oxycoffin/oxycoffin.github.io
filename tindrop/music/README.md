...
Catalog v3 is the current public release: 20 complete, individually evidenced
CC0 works, 52,911,030 audio bytes available on demand from R2, and a
1,215,309-byte signed manifest. Its SHA-256 is
`9ccebf96f45da28e3abd7b9aee4d590a8afb3d3ce493b3d38c897afaf7bfb922`.
All 20 beat maps were generated by the canonical Dart full-track analyzer. The
eight retired Tindrop Originals remain at their immutable R2 URLs only to avoid
breaking old drafts; no current catalog entry exposes them.
