...
SECTIONS: tuple[SectionDef, ...] = (
    ...
    SectionDef(
        ...
        fields=(
            FieldDef("app_update.current_version", "current_version", "text", "1.25.4+277", "Version actual publicada, incluyendo build suffix."),
            FieldDef("app_update.current_build_number", "current_build_number", "int", 277, "Build number publicado. Usado para evitar falsos positivos."),
